...
for id in range(number_of_observations):
    ...
    #print('TRYING TO MAKE EPSILON A FUNC OF INPUT LOGITS OR IMAGE: eps'      , epsilon)
    #print('TRYING TO MAKE EPSILON A FUNC OF INPUT LOGITS OR IMAGE: vec_b'      , vec_b)
    #print('TRYING TO MAKE EPSILON A FUNC OF INPUT LOGITS OR IMAGE: vec_b_wout' , vec_b_wout)
